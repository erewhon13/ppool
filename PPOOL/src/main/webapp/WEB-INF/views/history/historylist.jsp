						...
						<td style="width:80%"  align="left"  >							
							...
							<table class="history2" style="text-align:center; width:100%;">
								<tbody>
										...
										<tr>
											<td style="width:15%; color: black;" align="center"  bgcolor="#FF9147" height="40" width="20" >순번</td>
											<td style="width:30%; color: black;" align="center"  bgcolor="#FF9147" height="40" width="20">프로젝트명</td>
											<td style="width:20%; color: black;" align="center"  bgcolor="#FF9147" height="40" width="20">역할</td>
											<td style="width:15%; color: black;" align="center"  bgcolor="#FF9147" height="40" width="20">공개</td>
											<td style="width:20%; color: black;" align="center"  bgcolor="#FF9147" height="40" width="20">수행기간</td>
										</tr>
