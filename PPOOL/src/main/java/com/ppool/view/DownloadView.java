...
public class DownloadView extends AbstractView {
	...
	protected void renderMergedOutputModel(
		...
		HistoryUploadFile file = (HistoryUploadFile)model.get("uploadfile");
		...
		String encodedFileName = 
			new String(file.getUploadUserFileName().getBytes("euc-kr"), "iso-8859-1");
		response.addHeader(
			"Content-Disposition", 
		...
		String file2 = application.getRealPath(
			"/WEB-INF/uploadfiles/" + file.getUploadSavedFileName());
